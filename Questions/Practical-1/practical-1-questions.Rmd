...
```{r, fig.keep = "none"}
import.proportion.df <- read.csv('https://raw.githubusercontent.com/joetsui1994/Mbiol-Practical-2026/refs/heads/main/Data/daily_import_proportions.csv') %>%
  mutate(date=as.Date(date))
