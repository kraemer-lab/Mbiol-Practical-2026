...
```{r}
import.proportion.df <- read.csv('https://raw.githubusercontent.com/kraemer-lab/Mbiol-Practical-2025/refs/heads/main/Data/daily_import_proportions.csv') %>%
  mutate(date=as.Date(date))
